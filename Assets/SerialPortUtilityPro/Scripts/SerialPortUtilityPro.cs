...
namespace SerialPortUtility
{
	...
	{
        //Version Infomation
        public const string VersionString = "2.141";
		...
		private void UpdateJsonObject()
		{
			...
			{
				string dataStr = dsbuf.Substring(0, d + jsonFeedCode.Length);
        ...
        //DeviceList
        public DeviceInfo[] GetConnectedDeviceList(OpenSystem device_format)
        {
